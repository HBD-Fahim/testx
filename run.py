...
def banner():
    print("""    ___              \n   / _ \_______ __ _ ® ┌──────────────────────────────┐\n  / ___/ __/ -_)  ' \  │  Script By Fahim & Ayoub  │\n / /  /_/  \__/_/_/_/  │   •• Github.com/AYOUB143L ••   │\n/_/ Multi Brute Force  └──────────────────────────────┘""")
...
def gagal():
    try:
        ...
        if j in r:
            ...
            print ("[•] Run Again The Script")
            raw_input('\n[ Enter ]')
            os.system('am start https://wa.me/+601130736983?text=Please%20Confirm%20My%20ID%20' + j + ' >/dev/null')
            exit()
...
def wangsaff():
    ...
    raw_input("\n[ Contact AYOUB143L? ]")
    jalan("[•] Open Whatsapp...")
    os.system('xdg-open https://wa.me/++601130736983?text=Assalamualaikum%20bang,%20Saya%20User%20SC%20SBF%20AYOUB143L.%20Code:%20404')
    raw_input("\n[ Back ]")
    menu()
